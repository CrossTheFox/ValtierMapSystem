...
export const CyberProfile = ({ profile, accentColor, setAdminOpen, handleLogout }) => {
        ...
        <StyledProfile accent={accentColor} isOpen={isOpen}>
            ...
            {isOpen && (
                <div className="dropdown-menu">
                    ...
                    {/* <button className="menu-item" onClick={() => console.log("User Config...")}>
                        SETTINGS
                    </button> */}
